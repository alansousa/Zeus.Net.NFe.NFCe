...
namespace NFe.Danfe.Fast.NFCe
{
    ...
    public class DanfeFrNfce: DanfeBase
    {
        ...
        public DanfeFrNfce(nfeProc proc, ConfiguracaoDanfeNfce configuracaoDanfeNfce, string cIdToken, string csc)
        {
            ...
            Relatorio.PrintSettings.Copies = (proc.NFe.infNFe.ide.tpEmis == TipoEmissao.teNormal | (proc.protNFe.infProt != null && NfeSituacao.Autorizada(proc.protNFe.infProt.cStat))) ? 1 : 2;
            /*Se a NFe for autorizada, mesmo que seja em contingência, imprime somente uma via*/
